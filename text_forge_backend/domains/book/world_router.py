...
from domains.book.world_service import WorldService
...
async def create_location(
    ...
    return await service.create_location(
        request.book_id, request.model_dump(by_alias=False)
    )
...
async def update_location(
    ...
    instance = await service.update_location(
        location_id, request.book_id, request.model_dump(by_alias=False)
    )
    if not instance:
...
async def update_timeline_event(
    ...
    instance = await service.update_timeline_event(
        event_id, request.book_id, request.model_dump(by_alias=False)
    )
    if not instance:
...
async def create_foreshadowing(
    ...
    return await service.create_foreshadowing(
        request.book_id, request.model_dump(by_alias=False)
    )
...
async def update_foreshadowing(
    ...
    instance = await service.update_foreshadowing(
        item_id, request.book_id, request.model_dump(by_alias=False)
    )
    if not instance:
...
async def create_plot_thread(
    ...
    return await service.create_plot_thread(
        request.book_id, request.model_dump(by_alias=False)
    )
...
async def update_plot_thread(
    ...
    instance = await service.update_plot_thread(
        item_id, request.book_id, request.model_dump(by_alias=False)
    )
    if not instance:
