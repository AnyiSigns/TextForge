...
async def update_outline(
    ...
    item = await outline_service.update_outline(outline_id, chapter_id=chapter_id, summary=summary, **data)
    if item:
        raw_data = data.get("data")
        if raw_data:
            await outline_service.auto_summarize_if_needed(outline_id, book_id, user_id, raw_data)
    return item
