...
class VolumeService:
    ...
    async def create_volume(self, book_id: int, **data):
        try:
            ...
            raise AppException(status_code=500, detail="创建卷失败", error_code="CREATE_VOLUME_FAILED")
    ...
    async def update_volume(self, volume_id: int, **data):
        try:
            ...
            raise AppException(status_code=500, detail="更新卷失败", error_code="UPDATE_VOLUME_FAILED")
    ...
    async def delete_volume(self, volume_id: int):
        try:
            ...
            raise AppException(status_code=500, detail="删除卷失败", error_code="DELETE_VOLUME_FAILED")
