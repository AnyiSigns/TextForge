...
export interface CharacterCardActions {
  ...
  onAvatarChange: (id: number, e: React.ChangeEvent<HTMLInputElement>) => void;
  onUploadClick: (id: number) => void;
  avatarInputRefs: React.MutableRefObject<Record<number, HTMLInputElement | null>>;
}
...
export function CharacterCard(props: CharacterCardProps) {
  const {
    char, isEditing, editName, editDesc, editRole, viewMode,
    onName, onDesc, onRole, onSaveEdit, onCancelEdit,
