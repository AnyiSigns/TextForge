...
const ROLE_TEMPLATES: RoleTemplate[] = [
  {
    ...
    contextFields: ['outline_detail', 'plot_threads', 'foreshadowings', 'characters', 'branches', 'book_info'],
    layer: 'decision',
  },
  {
    id: 'storyboard',
    ...
    contextFields: ['outline_detail', 'outline_detail.chapter_scene_event', 'characters', 'branches', 'book_info'],
    layer: 'decision',
  },
  {
    id: 'writer',
    label: '执笔写手',
    executor: 'main',
    systemPrompt: '你是专业的小说执笔写手。职责：根据本章场景节点（时间/地点/出场角色/情节线/伏笔）、上一章正文与创作设定，写出指定章节的完整正文。要求：保持与前文一致的人设和世界观，文风自然流畅。若上下文中含「角色支线」素材（角色模拟沉淀的设定/冲突/台词），优先参考并自然融入正文。直接输出正文。',
    contextFields: ['book_info', 'setting', 'outline_detail.chapter_scene_event', 'previous_chapters', 'branches'],
    layer: 'execution',
  },
  {
    id: 'polish',
    ...
    contextFields: ['book_info', 'setting', 'previous_chapters'],
    layer: 'execution',
  },
  {
    id: 'compliance',
    ...
    contextFields: ['book_info', 'setting', 'outline_detail.chapter_scene_event'],
    layer: 'audit',
  },
  {
    id: 'plot',
    ...
    contextFields: ['plot_threads', 'foreshadowings', 'outline_detail.chapter_scene_event', 'branches', 'book_info'],
    layer: 'audit',
  },
  {
    id: 'chief',
    ...
    contextFields: ['book_info', 'setting', 'characters', 'locations', 'plot_threads', 'foreshadowings', 'branches'],
    layer: 'audit',
  },
];
