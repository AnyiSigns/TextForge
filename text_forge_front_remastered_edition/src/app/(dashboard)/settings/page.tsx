...
export default function SettingsPage() {
  ...
  return (
    <PageContainer>
      ...
      <div className="px-4 sm:px-6 py-5 flex flex-col lg:flex-row gap-5 items-start">
        <nav
          className="w-full lg:w-40 shrink-0 flex flex-row lg:flex-col gap-0.5 overflow-x-auto lg:overflow-visible pb-1 lg:pb-0"
          aria-label="设置分区"
        >
          {TABS.map((tab) => {
            const Icon = tab.icon;
            ...
            return (
              <button
                ...
                className={cn(
                  'flex items-center gap-2 px-3 h-9 rounded-lg text-[13px] font-medium transition-all duration-150 whitespace-nowrap cursor-pointer shrink-0',
                  active
